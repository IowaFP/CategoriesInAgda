...
- Category Theory. Steve Awodey. 
  - http://files.farka.eu/pub/Awodey_S._Category_Theory(en)(305s).pdf
...
- Type Theory in Type Theory using a Strictified Syntax. Ambrus Kaposi, Loic Pujet, ICFP 2025. 
  - https://dl.acm.org/doi/epdf/10.1145/3747535
...
## Lenses, bidirectional programming, and profunctor optics
...
- A tutorial on profunctor optics that is fairly accessible:
  - https://www.cs.ox.ac.uk/people/jeremy.gibbons/publications/poptics.pdf
- Profunctor optics for dummies
...
- Normalization By Evaluation For Type Theory In Type Theory.
  THORSTEN ALTENKIRCH AND AMBRUS KAPOSI 2017.
  - https://arxiv.org/pdf/1612.02462.
